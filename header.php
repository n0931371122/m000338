<header class="row position-fixed z-3 w-100 mx-0">
	...
	<div class="row col-auto col-lg-8 col-xl-6 position-relative flex-grow z-1 px-0 mx-0">
		<div class="row col-auto col-lg-9 flex-justify-space-between px-0 ml-auto mr-0 mx-lg-0">
			<div class="reservation d-none d-lg-flex col col-lg-4 flex-center cursor">
		...
		<div class="bg-white h-100">
			...
			<div class="block d-block d-lg-flex flex-center pr-md-4 px-4 mx-3">
				<div class="d-table d-lg-block mx-auto pt-5 pt-lg-0 mt-2 mt-lg-0">
					...
					<div class="border-top-black-2 lh16 text-center text-md-left pt-4 pb-4 pb-lg-0">
						<button class="menuReservation d-none d-md-block cursor text-hover-brown776356 mt-1 pb-1 mb-3">
							<i class="icon-mail font-15 mr-1"></i>
							<span class="NotoSerifTC">預約賞屋</span>
						</button>
						<div class="pt-3 pt-lg-0">
							<p class="mb-0">
								<span class="d-none d-md-inline">接待中心：</span>
								<a class="text-hover-brown776356" href="https://www.google.com.tw/maps/place/242%E6%96%B0%E5%8C%97%E5%B8%82%E6%96%B0%E8%8E%8A%E5%8D%80%E6%96%B0%E5%8C%97%E5%A4%A7%E9%81%93%E4%B8%89%E6%AE%B5163%E8%99%9F/@25.0600889,121.4497566,17z/data=!3m1!4b1!4m5!3m4!1s0x3442a90607cc4b8d:0x68fc734d675dfdd2!8m2!3d25.0600841!4d121.4519453?hl=zh-TW" target="_blank">新北市新莊區新北大道三段163號</a>
							</p>
							<p class="mb-0">
								<span>貴賓專線：</span>
								<a class="NotoSansTC text-hover-brown776356" href="tel:+886-2-85211008" target="_blank">02-85211008</a>
							</p>
						</div>
					</div>
				</div>
			</div>
			<div class="bottom position-absolute row w-100 mx-0">
				<div class="menuReservation d-flex d-lg-none col-6 flex-center cursor px-0">
					<i class="icon-mail flex-center font-15 mr-2 mt-1"></i>
					<span class="NotoSerifTC">預約賞屋</span>
				</div>
