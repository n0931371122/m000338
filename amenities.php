                ...
                <div class="section-1 mask pt-4 pt-sm-5 mt-3 mt-sm-0">
                    <div class="pt-lg-5 mt-lg-3">
                        ...
                        <div class="position-relative">
                            <div class="d-block d-lg-flex row mx-0 mb-4 px-4 px-xl-0">
                                <div class="blank"></div>
                                <div class="col-6 mycol-xl-2 px-0"></div>
                                <div class="mycol-xl-3 text-lg-right">
                                    <p class="font-65 lh1 mb-1">
                                        <span class="d-block" data-aos="fade-right" data-aos-delay="0">Enjoy a</span>
                                        <span class="d-block" data-aos="fade-right" data-aos-delay="50">Leisurely Realm</span>
                                        <span class="d-block" data-aos="fade-right" data-aos-delay="100">Above All</span>
                                    </p>
                                    <p class="NotoSerifTC font-26 font-weight-bold text-brown776356" data-aos="fade-right" data-aos-delay="150">享受凌駕於上的悠然境界</p>
                                </div>
                            ...
                            <div class="d-block d-lg-flex row mx-0 px-4 px-xl-0">
                                ...
                                <div class="mycol-xl-2">
                                    <div class="font-20 text-lg-right">
                                        <p class="font-weight-500 dec-line position-relative lh14">
                                            <span class="d-table border-bottom-brown776356 ml-lg-auto pb-3" data-aos="fade-right" data-aos-delay="0">地標高度 永恆質地</span>
                                        </p>
                                        <p class="text-6D6D6D lh165">
                                            <span class="d-block" data-aos="fade-right" data-aos-delay="50">稀有高空會所規劃</span>
                                            <span class="d-block" data-aos="fade-right" data-aos-delay="100">奢華的制高點</span>
                                            <span class="d-block" data-aos="fade-right" data-aos-delay="150">享受，難以超越的天空秘境</span>
                                        </p>
                                    </div>
                                </div>
                                ...
                                <div class="swiper-slide">
                                    ...
                                    <div class="text pl-xl-5 ml-xl-5 pt-md-4 pt-xl-5">
                                        <div class="px-4 pt-3 pt-md-0">
                                            <div class="max720 pr-md-5 mr-md-5 pr-xl-0 mr-xl-0">
                                                <p class="mb-1">
                                                    <span class="font-28 NotoSerifTC font-weight-bold mr-1">浮空無邊際泳池</span>
                                                    <span class="font-26">Skyrise Swimming Pool</span>
                                                </p>
                                                <p class="font-20 text-6D6D6D lh16">仰式，漂浮在凌空150米溫水無邊際泳池，日夜徜徉於雲朵、星空之中，水天一色，忘卻所有紛擾。</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="section-3 mask pt-xl-5 pb-5">
                    <div class="pb-xl-4 mb-xl-2">
                            ...
                            <div class="mycol-lg-3 z-1 pl-4 pl-lg-0 pr-4 pr-xl-5">
                                <div class="text-lg-right">
                                    <div class="pl-lg-4 pr-lg-2">
                                        <div class="max415 ml-lg-auto">
                                            <p class="font-65 lh1 mb-1">
                                                <span class="d-block" data-aos="fade-left" data-aos-delay="0">Drawing</span>
                                                <span class="d-block" data-aos="fade-left" data-aos-delay="50">Admirations</span>
                                            </p>
                                            <p class="font-26 NotoSerifTC font-weight-bold dec-line position-relative lh14 mb-lg-5" data-aos="fade-left" data-aos-delay="100">
                                                <span class="d-table text-brown776356 border-bottom-brown776356 ml-lg-auto pb-3 pb-md-4 pl-lg-3">探索奢華之源 訂製格調生活</span>
                                            </p>
                                            <p class="font-28 NotoSansTC pt-md-3 mb-2 mb-md-3" data-aos="fade-left">WATERFORD SKYLINE 水晶門廳</p>
                                            <p class="font-20 text-6D6D6D NotoSansTC lh16" data-aos="fade-left">WATERFORD首席設計師BILLY CANNING量身打造，9貫燈柱、5盞燈座，逾3萬顆水晶完美呈現全亞洲造價最高的頂級藝術之作，以33%最高純淨色澤令收藏家為之著迷。</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="d-block d-lg-flex row point-event-none mx-0 pb-xl-5 mb-xl-5 pt-4 pt-md-0">
                            <div class="blank"></div>
                            <div class="mycol-lg-3 d-flex align-center pl-4 pl-xl-0">
